...
\noindent
{\fontsize{9.0pt}{11.2pt}\selectfont\setlength{\columnsep}{16pt}\begin{multicols}{2}
...
\vspace{0.55em}
\noindent
\renewcommand{\arraystretch}{1.18}\begin{tabularx}{\linewidth}{@{}X@{\hspace{0.5em}}X@{}}
\textbf{3.} $f(x) = \ln(x^2 + 3x + 5)$ & \textbf{4.} $f(x) = x\ln x - x$ \\[0.15em]
\textbf{5.} $f(x) = \sin(\ln x)$ & \textbf{6.} $f(x) = \ln(\sin^2 x)$ \\[0.15em]
\textbf{7.} $f(x) = \ln\dfrac{1}{x}$ & \textbf{8.} $y = \dfrac{1}{\ln x}$ \\[0.25em]
\textbf{9.} $g(x) = \ln(xe^{-2x})$ & \textbf{10.} $g(t) = \sqrt{1 + \ln t}$ \\[0.2em]
\textbf{11.} $F(t) = (\ln t)^2 \sin t$ & \textbf{12.} $p(t) = \ln\sqrt{t^2 + 1}$ \\[0.2em]
\textbf{13.} $y = \log_8(x^2 + 3x)$ & \textbf{14.} $y = \log_{10}\sec x$ \\[0.2em]
\textbf{15.} $F(s) = \ln\ln s$ & \textbf{16.} $P(v) = \dfrac{\ln v}{1 - v}$ \\[0.25em]
\textbf{17.} $T(z) = 2^z \log_2 z$ & \textbf{18.} $g(t) = \ln\dfrac{t(t^2 + 1)^4}{\sqrt[3]{2t - 1}}$ \\[0.15em]
\textbf{19.} $y = \ln|3 - 2x^5|$ & \textbf{20.} $y = \ln(\csc x - \cot x)$ \\[0.15em]
\textbf{21.} $y = \ln(e^{-x} + xe^{-x})$ & \textbf{22.} $g(x) = e^{x^2 \ln x}$ \\[0.15em]
\textbf{23.} $h(x) = e^{x^2 + \ln x}$ & \textbf{24.} $y = \ln\sqrt{\dfrac{1 + 2x}{1 - 2x}}$ \\[0.15em]
...
\noindent
\renewcommand{\arraystretch}{1.18}\begin{tabularx}{\linewidth}{@{}X@{\hspace{0.5em}}X@{}}
\textbf{29.} $y = \sqrt{x}\ln x$ & \textbf{30.} $y = \dfrac{\ln x}{1 + \ln x}$ \\[0.25em]
...
\textbf{49.} $y = x^x$ & \textbf{50.} $y = x^{1/x}$ \\[0.2em]
\textbf{51.} $y = x^{\sin x}$ & \textbf{52.} $y = (\sqrt{x})^x$ \\[0.2em]
\textbf{53.} $y = (\cos x)^x$ & \textbf{54.} $y = (\sin x)^{\ln x}$ \\[0.2em]
...
\noindent
\renewcommand{\arraystretch}{1.18}\begin{tabularx}{\linewidth}{@{}X@{\hspace{0.5em}}X@{}}
\textbf{63.} $f(x) = \sin^{-1}(5x)$ & \textbf{64.} $g(x) = \sec^{-1}(e^x)$ \\[0.2em]
\textbf{65.} $y = \tan^{-1}\sqrt{x - 1}$ & \textbf{66.} $y = \tan^{-1}(x^2)$ \\[0.2em]
\textbf{67.} $y = (\tan^{-1}x)^2$ & \textbf{68.} $g(x) = \arccos\sqrt{x}$ \\[0.2em]
\textbf{69.} $h(x) = (\arcsin x)\ln x$ & \textbf{70.} $g(t) = \ln(\arctan(t^4))$ \\[0.2em]
