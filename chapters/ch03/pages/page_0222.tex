...
% Định nghĩa hệ màu chuẩn giáo trình Stewart Calculus
\definecolor{stewartcyan}{RGB}{0, 138, 194}
\definecolor{stewartred}{RGB}{218, 37, 29}

% Khung định nghĩa / quy tắc (definitionbox viền đỏ)
...
% Thiết lập tiêu đề đầu trang chuẩn Stewart
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\hspace*{0.27\textwidth}\fontsize{9}{11}\selectfont\textbf{\textsf{MỤC 3.2}}\hspace{1.5em}\textsf{Quy tắc nhân và Quy tắc thương}}
\fancyhead[R]{\fontsize{10}{12}\selectfont\textbf{\textsf{187}}}
