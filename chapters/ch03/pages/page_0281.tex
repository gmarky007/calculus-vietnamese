...
\usepackage[paperwidth=8.5in,paperheight=11in,top=0.65in,bottom=0.65in,left=0.75in,right=0.75in]{geometry}
\usepackage{fontspec}
...
\definecolor{exercisecyan}{RGB}{0,136,206}
\definecolor{lightrule}{RGB}{200,200,200}

% Icon graphing calculator tương tự nguyên tác James Stewart
\newcommand{\calcicon}{%
  \begin{tikzpicture}[x=0.085cm,y=0.085cm,baseline=-0.35ex]
    \draw[line width=0.55pt,draw=exercisecyan,rounded corners=0.6pt] (0,0) rectangle (9,12.5);
    \draw[line width=0.4pt,draw=exercisecyan] (1.2,7.2) rectangle (7.8,11.3);
    \draw[line width=0.45pt,draw=exercisecyan] (1.8,8.8) to[out=25,in=205] (4.8,10.2) to[out=25,in=195] (7.2,8.6);
    \foreach \x in {2.3, 4.5, 6.7}
      \foreach \y in {1.8, 3.5, 5.2}
        \fill[exercisecyan] (\x,\y) circle (0.35pt);
  \end{tikzpicture}%
}
