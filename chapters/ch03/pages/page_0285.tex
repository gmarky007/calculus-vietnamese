...
\usepackage[paperwidth=210mm, paperheight=297mm, left=14mm, right=14mm, top=18mm, bottom=16mm]{geometry}
\usepackage{fontspec}
...
\definecolor{stewartblue}{RGB}{0, 122, 194}
\newcommand{\stewartqed}{\hfill\textcolor{stewartblue}{\rule{1.1ex}{1.1ex}}}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textbf{\fontsize{10pt}{12pt}\selectfont 250}\hspace{2.5em}\textbf{\textsf{\fontsize{8.5pt}{10pt}\selectfont CHƯƠNG 3}}\hspace{1.5em}\textsf{\fontsize{8.5pt}{10pt}\selectfont Các quy tắc đạo hàm}}
\renewcommand{\headrulewidth}{0pt}
\setlength{\headheight}{14pt}
\setlength{\headsep}{14pt}

\fancyfoot[C]{\fontsize{6.5pt}{8pt}\selectfont\color{gray} Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part.}
