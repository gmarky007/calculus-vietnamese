...
\fancyhead[R]{\small\textsf{\textbf{MỤC 3.4}}\quad \textsf{Quy tắc chuỗi}\qquad \textbf{201}}

% Macro tạo chú thích dưới có dấu ngoặc nhọn màu xanh chuẩn xác
\newcommand{\cunder}[2]{%
  \begingroup
  \color{stewartcyan}%
  \underbrace{\normalcolor #1}_{\textsf{\fontsize{6.8pt}{8pt}\selectfont\color{stewartcyan}\begin{tabular}{@{}c@{}}#2\end{tabular}}}%
  \endgroup
}
