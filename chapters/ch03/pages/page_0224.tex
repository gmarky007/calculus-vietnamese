...
\usepackage[letterpaper, top=16mm, bottom=16mm, left=18mm, right=18mm]{geometry}
\usepackage{xcolor}
...
\definecolor{stewartcyan}{RGB}{0, 138, 190}
...
\fancyhead[R]{\small\textsf{\textbf{MỤC 3.2}}\quad \textsf{Quy tắc tích và quy tắc thương}\qquad \textbf{\normalsize 189}}
\fancyfoot[C]{%
    \fontsize{5.2pt}{6.2pt}\selectfont\color{stewartgray}%
...
\newcommand{\twoex}[4]{%
    \noindent\parbox[t]{0.48\columnwidth}{\textbf{#1.}\enspace #2}\hfill
    \parbox[t]{0.50\columnwidth}{\textbf{#3.}\enspace #4}\par\vspace{5.5pt}%
}
