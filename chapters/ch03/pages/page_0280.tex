...
\usepackage[letterpaper, top=20mm, bottom=22mm, left=18mm, right=18mm, headheight=14pt]{geometry}
...
\definecolor{tableheadcolor}{RGB}{218, 232, 242}

\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\fancyhead[R]{\small\textsf{\textbf{MỤC 3.8}\quad Tăng trưởng và suy giảm theo hàm mũ}\qquad\textbf{\textsf{245}}}
\fancyfoot[C]{\fontsize{7.5pt}{9pt}\selectfont\color{gray} Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part.}
