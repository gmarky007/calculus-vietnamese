...
\definecolor{pspurple}{RGB}{120, 50, 135}
\definecolor{psboxbg}{RGB}{243, 238, 247}

% Thiết lập Header và Footer chuẩn trang sách gốc (Trang chẵn 248)
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{%
  \makebox[144pt][l]{\fontsize{9}{11}\selectfont\textbf{248}}%
  \fontsize{9}{11}\selectfont\textsf{\textbf{CHƯƠNG 3}}\hspace{1.5em}\textsf{Các quy tắc đạo hàm}%
}
\renewcommand{\headrulewidth}{0pt}

\fancyfoot[C]{\fontsize{6}{7.5}\selectfont\textcolor{gray!80}{%
