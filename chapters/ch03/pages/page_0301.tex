...
\definecolor{stewartline}{RGB}{90, 175, 205}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\fontsize{9}{11}\selectfont\textbf{266}\qquad\textsf{\textbf{CHƯƠNG 3}}\quad\textsf{Các quy tắc tính đạo hàm}}
\fancyfoot[C]{\fontsize{7}{8.5}\selectfont\color{gray} Bản quyền 2021 Cengage Learning. Mọi quyền được bảo lưu. Không được sao chép, scan hoặc nhân bản toàn bộ hay một phần. WCN 02-200-203}
