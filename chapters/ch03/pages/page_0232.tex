...
\usepackage[a4paper,left=1.5cm,right=1.5cm,top=1.3cm,bottom=1.2cm,headheight=14pt,headsep=10pt]{geometry}
...
% Định nghĩa màu sắc nhận diện thương hiệu sách Stewart Calculus
...
\fancyhead[R]{\small\textsf{\textbf{MỤC 3.3}}\quad \textsf{Đạo hàm của các hàm số lượng giác}\qquad \textbf{\textsf{197}}}
\fancyfoot{}
