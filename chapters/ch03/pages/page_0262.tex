...
\usepackage[letterpaper, left=35pt, right=37pt, top=32pt, bottom=30pt, headheight=15pt, headsep=15pt, footskip=18pt]{geometry}
\usepackage{fontspec}
...
\fancyhead[L]{{\fontsize{8.5pt}{10pt}\selectfont\textsf{\textbf{MỤC 3.7}}\quad \textsf{Tốc độ thay đổi trong Khoa học Tự nhiên và Xã hội}}}
\fancyhead[R]{{\fontsize{8.5pt}{10pt}\selectfont\textsf{\textbf{227}}}}
\fancyfoot[C]{{\fontsize{5.5pt}{6.5pt}\selectfont\color{gray} Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part. WCN 02-200-203\\ Editorial review has deemed that any suppressed content does not materially affect the overall learning experience. Cengage Learning reserves the right to remove additional content at any time if subsequent rights restrictions require it.}}
...
\begin{minipage}[t]{125pt}
  \vspace*{73pt}
  \noindent\includegraphics[width=\linewidth]{images/p0262_fig1.png}
  \vspace{5pt}

  \noindent{\small\textsf{\textbf{HÌNH 2}}}

  \vspace{74pt}
  \noindent\includegraphics[width=\linewidth]{images/p0262_fig2.png}
  \vspace{7pt}
