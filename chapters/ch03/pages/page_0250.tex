...
\newcommand{\secrule}{{\color{stewartcyan}\rule{\linewidth}{0.6pt}}}

\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\fancyhead[R]{\small\textbf{\textsf{MỤC 3.5}}\quad \textsf{Đạo hàm ẩn}\qquad \textbf{\textsf{215}}}
...
% Biểu tượng công cụ vẽ đồ thị / CAS đặc trưng của Stewart Calculus
\newcommand{\graphicon}{%
  \begin{tikzpicture}[baseline=-0.3ex]
    \draw[stewartcyan, line width=0.65pt, rounded corners=0.4pt] (0,0) rectangle (1.2em, 1.0em);
    \draw[stewartcyan!65, line width=0.35pt] (0,0.5em) -- (1.2em,0.5em);
    \draw[stewartcyan!65, line width=0.35pt] (0.6em,0) -- (0.6em,1.0em);
    \draw[stewartcyan, line width=0.6pt] (0.15em,0.85em) to[out=-20,in=160] (1.05em,0.15em);
  \end{tikzpicture}%
}
