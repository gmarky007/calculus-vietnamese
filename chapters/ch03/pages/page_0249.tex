...
\usepackage[letterpaper, top=0.55in, bottom=0.5in, left=0.65in, right=0.65in]{geometry}
...
% Thiết lập tiêu đề trang chẵn (Trang 214)
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textsf{\textbf{214}}\qquad \textbf{\textsf{CHƯƠNG 3}}\quad \textsf{Các quy tắc đạo hàm}}
\fancyhead[R]{}
