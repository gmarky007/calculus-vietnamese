...
\usepackage[paperwidth=216mm,paperheight=279mm,left=18mm,right=18mm,top=22mm,bottom=20mm]{geometry}
\usepackage{fontspec}
...
\definecolor{stewartblue}{RGB}{0, 114, 152}

\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\fancyhead[L]{%
  {ontsize{10}{12}\selectfont \textbf{228}\qquad\textbf{\textsf{CHƯƠNG 3}}\qquad\textsf{Quy tắc tính đạo hàm}}%
}
\fancyfoot[C]{%
...
\switchcolumn[0]
\vspace*{0.2em}
\noindent\includegraphics[width=\linewidth]{images/p0263_fig2.png}\\[4pt]
\textbf{\textsf{HÌNH 6}}
