...
\definecolor{stewartcyan}{RGB}{0, 136, 163}
\definecolor{stewartline}{RGB}{90, 175, 220}
\definecolor{stewartred}{RGB}{185, 30, 30}
\definecolor{stewartgray}{RGB}{100, 100, 100}

% Biểu tượng công cụ vẽ đồ thị / Graphing Calculator chuẩn phong cách Stewart
\newcommand{\graphicon}{%
  \tikz[baseline=-1.5pt]{
    \draw[stewartcyan, line width=0.65pt, rounded corners=0.5pt] (0,0) rectangle (0.32,0.32);
    \draw[stewartcyan!50, line width=0.35pt] (0.04,0.16) -- (0.28,0.16);
    \draw[stewartcyan!50, line width=0.35pt] (0.16,0.04) -- (0.16,0.28);
    \draw[stewartcyan, line width=0.7pt] plot[domain=0.06:0.26, samples=15] (\x, {0.16 + 0.08*sin(deg((\x-0.16)*32))});
  }%
}

% Cấu hình Header và Footer theo đúng trang lẻ bản gốc (Header lệch về phía cột phải)
\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\fancyhead[R]{\textsf{\textbf{MỤC 3.10}\quad Xấp xỉ tuyến tính và vi phân}\qquad\textsf{\textbf{259}}}
\fancyfoot[C]{\fontsize{7.5pt}{9pt}\selectfont\color{stewartgray} Bản dịch tiếng Việt giáo trình Calculus: Early Transcendentals (9th Edition) -- James Stewart}
