...
% CAS / Graphing Calculator Icon
\newcommand{\casicon}{%
  \tikz[baseline=-0.5ex]{%
    \draw[stewartcyan, line width=0.8pt, rounded corners=0.8pt] (0,0) rectangle (0.34cm, 0.26cm);%
    \draw[stewartcyan, line width=0.6pt] (0.04cm, 0.07cm) sin (0.13cm, 0.20cm) cos (0.21cm, 0.06cm) sin (0.30cm, 0.17cm);%
  }%
}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\fontsize{9pt}{11pt}\selectfont\textbf{\textsf{270}}\qquad \textbf{\textsf{CHƯƠNG 3}}\quad \textsf{Các quy tắc tính đạo hàm}}
\fancyhead[R]{}
...
\fancyfoot[C]{%
  ...
  Chỉnh lý biên tập đã xác nhận rằng nội dung bị lược bỏ không ảnh hưởng đáng kể đến trải nghiệm học tập tổng thể. Cengage Learning bảo lưu quyền gỡ bỏ nội dung bổ sung vào bất kỳ lúc nào nếu các hạn chế về bản quyền sau đó yêu cầu.
}
