...
\usepackage[paperwidth=210mm, paperheight=280mm, left=62mm, right=22mm, top=22mm, bottom=18mm]{geometry}
...
\definecolor{stewartteal}{RGB}{0, 128, 155}
\newcommand{\stewartsquare}{\textcolor{stewartteal}{\rule{1.1ex}{1.1ex}}}

\pagestyle{fancy}
\fancyhf{}
\fancyheadoffset[lh]{46mm}
\fancyhead[L]{\fontsize{9}{11}\selectfont \textbf{234}\hspace{3.5em}\textsf{\textbf{CHƯƠNG 3}}\hspace{1.5em}\textsf{Các quy tắc đạo hàm}}
\renewcommand{\headrulewidth}{0pt}

\setlength{\parindent}{1.5em}
\setlength{\parskip}{0pt}

\newcommand{\stewartheading}[1]{%
  \vspace{1.3em}%
  \noindent\stewartsquare\hspace{0.5em}{\sffamily\bfseries #1}%
  \par\vspace{0.4em}\noindent%
}
