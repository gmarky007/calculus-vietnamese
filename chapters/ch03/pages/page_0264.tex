...
\usepackage[paperwidth=612pt, paperheight=792pt, left=175pt, right=45pt, top=45pt, bottom=40pt]{geometry}
\usepackage{fontspec}
...
\newcommand{\stewartsquare}{\textcolor{stewartblue}{\rule{1.1ex}{1.1ex}}}

\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\fancyhead[L]{{\fontsize{9}{11}\selectfont\sffamily\textbf{MỤC 3.7}\hspace{1.5em}Tốc độ thay đổi trong Khoa học Tự nhiên và Xã hội}}
\fancyhead[R]{{\fontsize{9}{11}\selectfont\sffamily\textbf{229}}}
