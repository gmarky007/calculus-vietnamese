...
\usepackage[a4paper,left=1.5cm,right=1.5cm,top=2cm,bottom=2cm,headheight=14pt]{geometry}
...
\fancyhead[R]{{\small\textsf{\textbf{\color{stewartdark}MỤC 3.2}}\quad\textsf{Quy tắc nhân và quy tắc thương}\quad\textbf{\color{stewartdark}185}}}
\fancyfoot[C]{}

% Môi trường khung định nghĩa chuẩn Stewart
