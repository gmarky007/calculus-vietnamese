...
\usepackage[paperwidth=8.5in, paperheight=11in, left=1.8cm, right=1.8cm, top=2.0cm, bottom=2.0cm, headheight=14pt]{geometry}
...
\definecolor{stewartcyan}{RGB}{0, 132, 198}
...
\fancyhead[R]{\textsf{\footnotesize \textbf{\color{stewartdark}MỤC 3.1}\quad Đạo hàm của đa thức và hàm mũ}\qquad\textsf{\textbf{\large 181}}}
