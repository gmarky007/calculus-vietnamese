...
\usepackage[paperwidth=216mm, paperheight=279mm, top=18mm, bottom=16mm, left=62mm, right=18mm, headheight=14pt, headsep=6mm, footskip=8mm]{geometry}
\usepackage{fontspec}
...
% Định nghĩa màu sắc theo bản gốc
\definecolor{discoverybg}{RGB}{239, 245, 241}
\definecolor{discoverygreen}{RGB}{0, 133, 95}
\definecolor{discoverydark}{RGB}{25, 30, 28}
\definecolor{sectionblue}{RGB}{0, 130, 195}
\definecolor{titlecharcoal}{RGB}{20, 25, 30}
\definecolor{formulaRed}{RGB}{205, 45, 40}

% Cài đặt Header
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textsf{\fontsize{8.5}{10}\selectfont\color{gray!80!black} MỤC 3.6 \quad Đạo hàm của hàm logarit và hàm lượng giác ngược}}
\fancyhead[R]{\textsf{\fontsize{10}{12}\selectfont\bfseries 217}}
\renewcommand{\headrulewidth}{0pt}

% Icon dự án khám phá dạng vector
\newcommand{\projecticon}{%
  \begin{tikzpicture}[x=1pt, y=1pt, baseline=1pt]
    \draw[discoverygreen, line width=0.6pt] (0,1) -- (0,10) -- (5.5,12) -- (11,10) -- (11,1) -- (5.5,3) -- cycle;
    \draw[discoverygreen, line width=0.6pt] (5.5,3) -- (5.5,12);
    \draw[discoverygreen, line width=0.45pt] (1.8,4.5) -- (4,5.3);
    \draw[discoverygreen, line width=0.45pt] (1.8,7) -- (4,7.8);
    \draw[discoverygreen, line width=0.45pt] (7,5.3) -- (9.2,4.5);
    \draw[discoverygreen, line width=0.45pt] (7,7.8) -- (9.2,7);
  \end{tikzpicture}%
}
