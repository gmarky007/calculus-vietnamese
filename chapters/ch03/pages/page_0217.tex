...
\usepackage{enumitem}
\usepackage{fancyhdr}
\usepackage[top=1.8cm, bottom=1.8cm, left=1.6cm, right=1.6cm, headheight=14pt]{geometry}

\definecolor{stewartcyan}{RGB}{0, 150, 214}
\definecolor{stewartdark}{RGB}{30, 30, 30}

\newcommand{\casicon}{%
  \tikz[baseline=-0.6ex]{%
    \fill[stewartcyan!15, rounded corners=0.5pt] (0,0) rectangle (0.36cm,0.27cm);
    \draw[stewartcyan, line width=0.6pt, rounded corners=0.5pt] (0,0) rectangle (0.36cm,0.27cm);
    \draw[stewartcyan, line width=0.35pt] (0.04cm,0.135cm) -- (0.32cm,0.135cm);
    \draw[stewartcyan, line width=0.35pt] (0.18cm,0.03cm) -- (0.18cm,0.24cm);
    \draw[stewartcyan, line width=0.7pt, smooth] plot coordinates {(0.05cm,0.06cm) (0.12cm,0.21cm) (0.23cm,0.06cm) (0.31cm,0.20cm)};
  }%
}

\newcommand{\colrule}{\vspace{0.45em}{\color{stewartcyan}\hrule height 0.5pt}\vspace{0.45em}}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\fontsize{9}{11}\selectfont\textbf{182}\qquad \textbf{\textsf{CHƯƠNG 3}}\quad \textsf{Quy tắc tính đạo hàm}}
