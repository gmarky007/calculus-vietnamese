...
\usepackage[paperwidth=8.5in, paperheight=11in, top=20mm, bottom=18mm, left=14mm, right=14mm]{geometry}
...
\definecolor{stewartpurple}{RGB}{82, 36, 127}
\definecolor{stewartlightpurple}{RGB}{235, 233, 246}
\definecolor{stewartgray}{RGB}{100, 100, 100}

\setlength{\parindent}{0pt}
\setlength{\parskip}{4pt}

% Icon vẽ đồ thị cho Bài toán 2
\newcommand{\graphingicon}{%
  \raisebox{-0.6pt}{%
    \begin{tikzpicture}[x=1pt, y=1pt, baseline=2pt]
      \draw[stewartcyan, line width=0.6pt, rounded corners=0.6pt, fill=white] (0,0) rectangle (9.5, 9.5);
      \draw[stewartcyan!70, line width=0.4pt] (4.75, 0.8) -- (4.75, 8.7);
      \draw[stewartcyan!70, line width=0.4pt] (0.8, 4.75) -- (8.7, 4.75);
      \draw[stewartcyan, line width=0.7pt, smooth] plot coordinates {(1.5, 2.2) (4.75, 7.5) (8, 2.2)};
    \end{tikzpicture}%
  }%
}
