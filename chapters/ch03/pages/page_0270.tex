...
% Màu chuẩn phong cách James Stewart Calculus
...
\fancyhead[L]{\textsf{\textbf{MỤC 3.7}}\quad \textsf{Tốc độ thay đổi trong Khoa học Tự nhiên và Xã hội}}
\fancyhead[R]{\textsf{\textbf{235}}}
\fancyfoot[C]{\scriptsize\color{stewartgray}Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part.}

% Biểu tượng CAS / phần mềm đồ thị
\newcommand{\graphicon}{%
    \begin{tikzpicture}[baseline=-0.5ex, scale=0.75]%
        \draw[stewartcyan, thick, rounded corners=0.8pt] (0,0) rectangle (0.38, 0.28);%
        \draw[stewartcyan, thick] (0.04, 0.08) sin (0.19, 0.22) cos (0.34, 0.06);%
    \end{tikzpicture}%
}
