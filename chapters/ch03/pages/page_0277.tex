...
\usepackage[letterpaper, top=2cm, bottom=2cm, left=1.8cm, right=1.8cm]{geometry}
...
% Định nghĩa hệ màu sách Stewart
\definecolor{stewartcyan}{RGB}{0, 130, 185}

% Cấu hình tiêu đề đầu trang (Trang chẵn 242)
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textsf{\textbf{242}}\qquad \textbf{\textsf{CHƯƠNG 3}}\quad \textsf{Các quy tắc tính đạo hàm}}
\fancyhead[R]{}
