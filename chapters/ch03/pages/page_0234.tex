...
\usepackage[paperwidth=8.5in, paperheight=11in, left=0.7in, right=0.7in, top=0.65in, bottom=0.6in]{geometry}
...
% Biểu tượng máy tính CAS / đồ họa chuẩn bản gốc
\newcommand{\casicon}{%
  \tikz[baseline=-1pt]{%
    \draw[stewartcyan, fill=stewartcyan!12, rounded corners=1pt, line width=0.6pt] (0,0) rectangle (9.5pt,9.5pt);
    \draw[stewartcyan, line width=0.8pt, line join=round] (1.5pt,2.8pt) .. controls (4pt,8.5pt) and (5.5pt,1.5pt) .. (8pt,6.8pt);
  }%
}
...
\fancyhead[R]{\fontsize{8.5pt}{10pt}\selectfont\textsf{\textbf{MỤC 3.4}}\quad\textsf{Quy tắc chuỗi}\quad\textbf{\textsf{199}}}
