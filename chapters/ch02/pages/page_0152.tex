...
\usepackage[paperwidth=210mm, paperheight=297mm, left=68mm, right=18mm, top=24mm, bottom=22mm, marginparwidth=45mm, marginparsep=6mm, headheight=14pt]{geometry}
...
\definecolor{annotblue}{RGB}{0, 130, 190}

% Ký hiệu dấu ngoặc phần nguyên
...
\fancyhead[R]{{\small\sffamily\bfseries MỤC 2.5}\quad{\small\sffamily Tính liên tục}\qquad{\normalsize\sffamily\bfseries 117}}
\fancyfoot[L]{%
  \begin{minipage}{\textwidth}
    \tiny\color{black!70}
    Bản quyền 2021 Cengage Learning. Bảo lưu mọi quyền. Không được sao chép, quét hoặc tái bản, toàn bộ hay một phần.
  \end{minipage}%
}
