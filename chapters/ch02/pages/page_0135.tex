...
\usepackage[letterpaper, top=20mm, bottom=20mm, left=18mm, right=18mm]{geometry}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\fontsize{9}{11}\selectfont\textbf{100}\hspace{2.5em}\textbf{\textsf{CHƯƠNG 2}}\hspace{1.2em}\textsf{Giới hạn và Đạo hàm}}
