...
% Thiết lập kích thước trang chuẩn theo sách giáo trình Stewart Calculus
\geometry{
  paperwidth=210mm,
  paperheight=279mm,
  left=15mm,
...
% Định nghĩa màu sắc thương hiệu của sách James Stewart
\definecolor{stewartcyan}{RGB}{0, 119, 182}
\definecolor{tableheader}{RGB}{221, 233, 242}
...
\fancyhead[R]{%
  \textsf{\textbf{MỤC 2.1}\hspace{1.5em}\textmd{Bài toán Tiếp tuyến và Vận tốc}}\hspace{3.5em}\textbf{\textsf{81}}%
}
\fancyfoot[C]{%
  \fontsize{6.5pt}{8pt}\selectfont\color{gray!90}%
  Bản quyền © 2021 Cengage Learning. Bảo lưu mọi quyền. Không được sao chép, quét hoặc nhân bản toàn bộ hay một phần.%
}
