...
\definecolor{lightcyanline}{RGB}{180, 218, 228}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{{\small\sffamily\textbf{MỤC 2.5}}\quad {\small\sffamily Sự liên tục}\qquad \textbf{\textsf{125}}}
\renewcommand{\headrulewidth}{0pt}

% Icon máy tính vẽ đồ thị chuẩn Stewart
\newcommand{\graphingcalcicon}{%
  \begin{tikzpicture}[scale=0.85, baseline=-0.6ex]
    \draw[color=stewartcyan, fill=white, rounded corners=0.8pt, line width=0.65pt] (0,0) rectangle (0.34, 0.28);
    \draw[color=stewartcyan!70, line width=0.45pt] (0.04, 0.14) -- (0.30, 0.14);
    \draw[color=stewartcyan!70, line width=0.45pt] (0.17, 0.03) -- (0.17, 0.25);
    \draw[color=stewartcyan, line width=0.7pt, smooth] plot coordinates {(0.06, 0.06) (0.17, 0.22) (0.28, 0.08)};
  \end{tikzpicture}%
}
