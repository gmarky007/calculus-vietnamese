...
\usepackage[paperwidth=210mm, paperheight=297mm, left=20mm, right=20mm, top=20mm, bottom=20mm, headheight=14pt, headsep=12pt]{geometry}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\fontsize{9}{11}\selectfont\textbf{\textsf{136}}\hspace{2.5em}\textbf{\textsf{CHƯƠNG 2}}\hspace{1.2em}\textsf{Giới hạn và Đạo hàm}}
\renewcommand{\headrulewidth}{0pt}

\fancyfoot[C]{\fontsize{6.5}{8}\selectfont\color{gray}
