...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\small\textsf{\textbf{MỤC 2.8}}\quad\textsf{Đạo hàm dưới dạng một hàm số}\qquad\textbf{\textsf{157}}}
\renewcommand{\headrulewidth}{0pt}
\fancyfoot[C]{\fontsize{6.5}{8}\selectfont\color{gray!80}Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part. WCN 02-200-203}
