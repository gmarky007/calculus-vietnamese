...
\usepackage[letterpaper, left=65mm, right=20mm, top=20mm, bottom=18mm, marginparwidth=44mm, marginparsep=7mm, reversemarginpar]{geometry}
\usepackage{fontspec}
...
\definecolor{stewartblue}{RGB}{0, 120, 185}
\definecolor{stewartred}{RGB}{205, 32, 38}
\definecolor{stewartpurple}{RGB}{102, 60, 140}
...
\fancyhfoffset[L]{51mm}
\fancyhead[L]{%
  \makebox[44mm][l]{\textsf{\textbf{132}}}%
  \hspace{7mm}%
  \textsf{\textbf{CHƯƠNG 2}}\quad \textsf{Giới hạn và Đạo hàm}%
}
