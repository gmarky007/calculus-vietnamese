...
\usepackage[paperwidth=210mm, paperheight=280mm, left=18mm, right=18mm, top=16mm, bottom=18mm]{geometry}
...
\definecolor{stewartline}{RGB}{70, 160, 215}
\definecolor{stewarttitle}{RGB}{15, 45, 85}

% Biểu tượng đồ thị máy tính/màn hình nhỏ trước các bài toán CAS
\newcommand{\graphicon}{%
  \begin{tikzpicture}[x=1ex, y=1ex, baseline=-0.25ex]
    \draw[fill=cyan!12, draw=cyan!80!black, line width=0.55pt, rounded corners=0.6pt] (0,0) rectangle (1.4, 1.25);
    \draw[red!80!black, line width=0.55pt] (0.2, 0.35) sin (0.7, 0.95) cos (1.2, 0.3);
