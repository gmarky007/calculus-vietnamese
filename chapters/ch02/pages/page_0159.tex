...
\usepackage[margin=1.4cm, top=1.8cm, bottom=1.8cm, footskip=0.6cm]{geometry}
...
% Cấu hình Header và Footer theo đúng trang chẵn chuẩn của sách
\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\fancyhead[L]{\fontsize{9}{11}\selectfont\textbf{124}\hspace{20pt}\textbf{\textsf{CHƯƠNG 2}}\hspace{8pt}\textsf{Giới hạn và Đạo hàm}}
\fancyfoot[C]{\fontsize{6.5}{7.5}\selectfont\color{stewartgray}Copyright 2021 Cengage Learning. Mọi quyền được bảo lưu. Không được sao chép, quét hoặc nhân bản toàn bộ hay một phần. WCN 02-200-203}
