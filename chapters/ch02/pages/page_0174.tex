...
\usepackage[letterpaper, top=1.8cm, bottom=1.8cm, left=1.8cm, right=1.8cm, headheight=14pt, headsep=15pt, footskip=18pt]{geometry}
...
\definecolor{stewartblue}{RGB}{0, 113, 188}

\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\fancyhead[R]{\textsf{\textbf{MỤC 2.6}}\quad \textsf{Giới hạn tại vô cực; Tiệm cận ngang}\qquad \textsf{\textbf{139}}}
...
\newcommand{\graphicon}{%
  \begin{tikzpicture}[baseline=-0.6ex, x=1ex, y=1ex]
    \draw[stewartblue, line width=0.7pt, rounded corners=0.5pt] (0,-0.1) rectangle (1.4, 1.1);
    \draw[stewartblue, line width=0.5pt] (0.2, 0.2) -- (0.5, 0.8) -- (0.8, 0.3) -- (1.2, 0.9);
  \end{tikzpicture}%
}
\newcommand{\marginicon}{\makebox[0pt][r]{\graphicon\hspace{4pt}}}
