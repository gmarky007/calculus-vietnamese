...
\definecolor{stewartred}{RGB}{204, 30, 41}

% Thiết lập header
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\textsf{\textbf{MỤC 2.7}}\hspace{1.5em}\textsf{Đạo hàm và Tốc độ thay đổi}\hspace{2.5em}\textsf{\textbf{143}}}
\renewcommand{\headrulewidth}{0pt}

% Thiết lập môi trường khung định nghĩa
