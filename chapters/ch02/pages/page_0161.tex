...
% Ký hiệu hàm phần nguyên ngoặc kép kín chuẩn
\DeclareRobustCommand{\llbracket}{[\kern-1.5pt[}
\DeclareRobustCommand{\rrbracket}{]\kern-1.5pt]}

% Biểu tượng máy tính vẽ đồ thị chuẩn Stewart
\newcommand{\graphingcalcicon}{%
  \begin{tikzpicture}[baseline=-0.5ex, scale=0.68]
    \draw[thick, stewartcyan, rounded corners=0.8pt] (0,0) rectangle (0.42, 0.42);
    \draw[stewartcyan!70, line width=0.45pt] (0.06, 0.21) -- (0.36, 0.21);
    \draw[stewartcyan!70, line width=0.45pt] (0.21, 0.06) -- (0.21, 0.36);
    \draw[stewartcyan, line width=0.8pt] (0.08, 0.09) to[out=38, in=222] (0.34, 0.33);
  \end{tikzpicture}%
}
...
\fancyhead[L]{\textbf{\textsf{\large 126}}\qquad\textbf{\textsf{CHƯƠNG 2}}\quad\textsf{Giới hạn và Đạo hàm}}
\fancyfoot[C]{\fontsize{6.5pt}{8pt}\selectfont\color{black!55}Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part.\\ Bản dịch tiếng Việt giáo trình \textit{Calculus: Early Transcendentals (9th Edition)} -- James Stewart.}

% Tinh chỉnh khoảng cách toán học gọn gàng theo sách xuất bản
