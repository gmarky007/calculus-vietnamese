...
% Fallback cho ký hiệu ngoặc phần nguyên nếu không có stmaryrd
\ifdefined\llbracket\else
  \newcommand{\llbracket}{[\![}
  \newcommand{\rrbracket}{]\!]}
\fi
...
% Định nghĩa màu sắc nhận diện của sách Stewart Calculus
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\fontsize{9}{11}\selectfont\textbf{116}\hspace{2.5em}\textbf{\textsf{CHƯƠNG 2}}\hspace{1.5em}\textsf{Giới hạn và Đạo hàm}}
...
\begin{minipage}{\textwidth}
    \centering
    \begin{tikzpicture}
        \node[anchor=south west, inner sep=0] (fig) at (0,0) {\includegraphics[width=\textwidth]{images/p0151_fig1.png}};
