...
\usepackage{fancyhdr}
\usepackage[letterpaper, top=18mm, bottom=20mm, left=18mm, right=18mm, headheight=14pt]{geometry}

% Định nghĩa màu sắc thương hiệu Stewart Calculus
\definecolor{stewartcyan}{RGB}{0, 136, 170}
\definecolor{stewartgreen}{RGB}{0, 128, 75}
\definecolor{stewartred}{RGB}{185, 25, 40}
\definecolor{stewartgray}{RGB}{100, 100, 100}

% Thiết lập Header chuẩn sách Stewart (dóng chính xác trên cột nội dung chính)
\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\fancyhead[R]{\parbox{0.68\textwidth}{\textsf{\textbf{MỤC 2.4}}\hspace{1.5em}\textsf{Định nghĩa chính xác của giới hạn}\hfill\textsf{\textbf{109}}}}
