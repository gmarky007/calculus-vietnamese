...
\usepackage{fancyhdr}
\usepackage[paperwidth=8.5in, paperheight=11in, top=0.45in, bottom=0.45in, left=0.65in, right=0.65in, headheight=14pt, headsep=10pt, footskip=16pt]{geometry}
...
\fancyhead[R]{%
  ...
  \textbf{\textsf{\color{stewartdark}MỤC 2.4}}\quad \textsf{\color{stewartdark}Định nghĩa chính xác của giới hạn}\qquad \textbf{\color{stewartdark}113}}%
}
\fancyfoot[C]{%
  \fontsize{6.5}{7.5}\selectfont\color{stewartgray}
  Bản quyền thuộc Cengage Learning. Đã đăng ký mọi quyền. Không được sao chép, quét hoặc nhân bản toàn bộ hay một phần do các hạn chế về bản quyền.
}

% Macro biểu tượng đồ họa (Graphing calculator icon)
\newcommand{\graphicon}{%
  \tikz[baseline=-0.6ex]{%
    \draw[stewartcyan, line width=0.6pt, rounded corners=0.8pt, fill=stewartcyan!12] (0, -0.02) rectangle (0.32, 0.28);
    \draw[stewartcyan, line width=0.5pt] (0.04, 0.05) to[out=20, in=200] (0.28, 0.22);
    \fill[stewartcyan] (0.16, 0.135) circle (0.6pt);
  }%
}
...
\begin{minipage}[t]{0.48\textwidth}
  ...
  \smallskip
  {\centering \includegraphics[height=2.5cm, keepaspectratio]{images/p0148_fig2.png}\par}
  ...
  \smallskip
  {\centering \includegraphics[height=2.6cm, keepaspectratio]{images/p0148_fig4.png}\par}
  ...
  \smallskip
  {\centering \includegraphics[height=2.4cm, keepaspectratio]{images/p0148_fig5.png}\par}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.485\textwidth}
  ...
  \smallskip
  {\centering \includegraphics[height=2.5cm, keepaspectratio]{images/p0148_fig3.png}\par}
