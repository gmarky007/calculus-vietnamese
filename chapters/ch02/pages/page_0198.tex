...
% Màu sắc nhận diện thương hiệu sách Stewart Calculus
\definecolor{stewartcyan}{RGB}{0, 130, 185}
\definecolor{stewarttablehead}{RGB}{232, 240, 248}
\definecolor{stewartgrid}{RGB}{160, 185, 210}
\definecolor{stewartrule}{RGB}{195, 215, 230}

% Biểu tượng CAS (Graphing Calculator) bên lề bài tập
\newcommand{\casicon}{%
  \begin{tikzpicture}[scale=0.85, baseline=-1.5pt]
    \draw[stewartcyan, thick, rounded corners=0.8pt] (0,0) rectangle (9.5pt,9.5pt);
    \draw[stewartcyan, fill=cyan!12] (1.2pt,1.2pt) rectangle (8.3pt,8.3pt);
    \draw[stewartcyan, thick] (2.0pt,2.8pt) .. controls (4.2pt,8.8pt) and (5.4pt,1.0pt) .. (7.4pt,6.5pt);
  \end{tikzpicture}%
}
...
\fancyhead[R]{\textsf{\textbf{\color{stewartcyan}MỤC 2.8}}\quad\textsf{Đạo hàm như một hàm số}\qquad\textbf{163}}
\fancyhead[L]{}
\fancyfoot[C]{\fontsize{6.5pt}{8pt}\selectfont\color{gray} Bản quyền 2021 Cengage Learning. Bảo lưu mọi quyền. Không được sao chép, quét hoặc nhân bản toàn bộ hay một phần. WCN 02-200-203}
