...
\usepackage[top=1.8cm, bottom=1.8cm, left=1.8cm, right=1.5cm, headheight=14pt, headsep=12pt]{geometry}
...
\fancyhead[R]{\fontsize{9pt}{11pt}\selectfont \textbf{\textsf{MỤC 2.3}}\hspace{1.5em}Tính giới hạn bằng các quy tắc giới hạn\hspace{2.5em}\textbf{\textsf{97}}}
\fancyfoot[C]{\fontsize{7.5pt}{9pt}\selectfont\color{gray!80}Bản dịch tiếng Việt dùng cho mục đích học tập và nghiên cứu. Nguyên tác: \textit{Calculus: Early Transcendentals (9th Edition)} -- James Stewart.}
