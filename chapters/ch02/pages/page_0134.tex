...
\usepackage[paperwidth=8.5in,paperheight=11in,top=0.8in,bottom=0.8in,left=0.8in,right=0.8in,headheight=14pt,footskip=0.4in]{geometry}
\usepackage{amsmath,amssymb,amsfonts}
\usepackage{xcolor}
\usepackage{fancyhdr}

% Định nghĩa màu sắc chuẩn sách Calculus của James Stewart
\definecolor{stewartcyan}{RGB}{0, 130, 195}

% Cấu hình Header và Footer dóng chính xác theo cột nội dung chính
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\parbox{0.71\textwidth}{\sffamily\footnotesize\textbf{MỤC 2.3}\quad Tính giới hạn bằng các quy tắc giới hạn\hfill\textbf{\normalsize 99}}}
