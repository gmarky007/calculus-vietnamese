...
% Cấu hình header dóng hàng hoàn hảo với cột nội dung chính (rộng 12.8cm bên phải)
\pagestyle{fancy}
\fancyhf{}
...
\fancyhead[R]{%
  \makebox[\textwidth][r]{%
    \makebox[12.8cm][l]{%
      \small\textsf{\textbf{MỤC 2.6}}\hspace{1.5em}\textsf{Giới hạn tại vô cực; Tiệm cận ngang}\hfill\textsf{\textbf{135}}%
    }%
  }%
}
