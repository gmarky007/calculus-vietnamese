...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\small\textsf{\textbf{MỤC 2.8}}\quad\textsf{Đạo hàm dưới dạng một hàm số}\qquad\textsf{\textbf{155}}}
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0pt}
\fancyfoot[C]{%
    \fontsize{6.5pt}{8pt}\selectfont\color{gray}
    Bản quyền thuộc về Cengage Learning. Mọi quyền được bảo lưu. Không được sao chép, quét hoặc nhân bản toàn bộ hoặc một phần. WCN 02-200-203\\
    Đánh giá của ban biên tập cho thấy bất kỳ nội dung nào bị lược bỏ không ảnh hưởng đáng kể đến trải nghiệm học tập tổng thể.
}
