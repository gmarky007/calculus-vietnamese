...
\definecolor{stewartred}{RGB}{185, 27, 36}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textsf{\textbf{\large 96}}\hspace{1.8cm}\textsf{\textbf{CHƯƠNG 2}}\hspace{0.5cm}\textsf{Giới hạn và Đạo hàm}}
\fancyhead[R]{}
\renewcommand{\headrulewidth}{0pt}

\fancyfoot[C]{%
    \footnotesize\color{gray}
    \textcopyright\ 2021 Cengage Learning. Bản quyền được bảo lưu. Không được sao chép, scan hoặc tái bản toàn bộ hay một phần. WCN 02-200-203\\
    Đánh giá biên tập đã xác định rằng mọi nội dung bị lược bỏ không ảnh hưởng đáng kể đến trải nghiệm học tập tổng thể. Cengage Learning bảo lưu quyền xóa nội dung bổ sung vào bất kỳ lúc nào nếu có yêu cầu hạn chế về quyền.
}
