...
\usepackage[letterpaper, top=1.8cm, bottom=2cm, left=1.8cm, right=1.8cm]{geometry}
\usepackage{multicol}
\usepackage{xcolor}
\usepackage{enumitem}
\usepackage{fancyhdr}

\definecolor{stewartcyan}{RGB}{0, 140, 190}
\definecolor{headgray}{RGB}{110, 110, 110}
...
\fancyhead[R]{{\small\sffamily\color{headgray}\textbf{CHƯƠNG 2}\quad Ôn tập}\qquad{\normalsize\sffamily\textbf{167}}}
