...
\usepackage{graphicx}
\usepackage[paperwidth=8.5in, paperheight=11in, top=0.5in, bottom=0.5in, left=0.7in, right=0.7in]{geometry}
\usepackage{fancyhdr}
\usepackage{xcolor}
\usepackage{tikz}
\usepackage{enumitem}
...
\fancyhead[R]{\sffamily\textbf{\footnotesize CHƯƠNG 2}\hspace{1.5em}\textsf{\footnotesize Ôn tập}\hspace{1.5em}\textbf{\normalsize 169}}
