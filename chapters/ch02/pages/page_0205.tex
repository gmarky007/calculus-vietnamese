...
% Màu sắc nhận diện chuẩn sách giáo trình Stewart Calculus
\definecolor{stewartcyan}{RGB}{0, 140, 186}
\definecolor{tableheader}{RGB}{225, 235, 245}

% Ký hiệu hàm phần nguyên ngoặc kép kín đẹp
\makeatletter
\DeclareRobustCommand{\llbracket}{[\mkern-2.5mu[}
\DeclareRobustCommand{\rrbracket}{]\mkern-2.5mu]}
\makeatother

% Cấu hình đầu trang và chân trang chuẩn bản gốc Stewart trang 170
\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\fancyhead[L]{\fontsize{9}{11}\selectfont \textbf{\textsf{170}}\hspace{2.5em}\textbf{\textsf{CHƯƠNG 2}}\hspace{1.2em}\textsf{Giới hạn và Đạo hàm}}
\fancyfoot[C]{\fontsize{6.5}{8}\selectfont \textcolor{gray}{Bản quyền 2021 Cengage Learning. Bảo lưu mọi quyền. Không được sao chép, quét hoặc nhân bản toàn bộ hay một phần.}}
