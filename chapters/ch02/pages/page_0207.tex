...
\definecolor{copyrightgray}{RGB}{90, 90, 90}

% Ký hiệu hàm phần nguyên lớn nhất [[x]]
\providecommand{\llbracket}{[\mkern-2.5mu[\mkern1mu}
\providecommand{\rrbracket}{\mkern1mu]\mkern-2.5mu]}
