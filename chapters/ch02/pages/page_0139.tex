...
\usepackage[letterpaper, top=1.3cm, bottom=1.5cm, left=1.5cm, right=1.5cm, headheight=14pt, headsep=12pt]{geometry}
...
% Định nghĩa ký hiệu ngoặc phần nguyên lớn nhất kiểu Stewart
\makeatletter
...
% Bảng màu Stewart
\definecolor{stewartcyan}{RGB}{0, 120, 150}
\definecolor{lightgraytext}{gray}{0.35}

% Cấu hình header & footer
\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\fancyhead[L]{\fontsize{9}{11}\selectfont \textbf{104}\hspace{2em}\textcolor{stewartcyan}{\textbf{\textsf{CHƯƠNG 2}}}\hspace{1.5em}\textsf{Giới hạn và Đạo hàm}}
\fancyfoot[C]{\fontsize{7.5}{9}\selectfont\color{lightgraytext}Bản dịch tiếng Việt dành cho mục đích học tập và nghiên cứu. Nguyên tác: James Stewart - Calculus: Early Transcendentals (9th Edition).}

% Tinh chỉnh khoảng cách toán học display
