...
\usepackage[letterpaper, left=180pt, right=45pt, top=45pt, bottom=40pt]{geometry}
\usepackage{graphicx}
\usepackage{tikz}
\usepackage{xcolor}
\usepackage{colortbl}
...
\newcommand{\blockarrow}{%
  \tikz[baseline=-0.2ex]{%
    \fill[cyan!35!gray!50] (-0.11, 0.32) -- (0.11, 0.32) -- (0.11, 0.08) -- (0.25, 0.08) -- (0, -0.16) -- (-0.25, 0.08) -- (-0.11, 0.08) -- cycle;
  }%
}
