...
% Macro tạo ô số thứ tự chuẩn xác
\newcommand{\stewartboxnum}[1]{%
  \tcbox[
    colback=white,
    colframe=stewartred,
    boxrule=0.9pt,
    ...
    left=3.5pt,
    right=3.5pt
  ]{\bfseries\sffamily\fontsize{9pt}{10pt}\selectfont\color{stewartred}#1}%
}

% Cấu hình Header và Footer
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textbf{\sffamily\fontsize{10pt}{12pt}\selectfont 106}\qquad\textbf{\sffamily\fontsize{10pt}{12pt}\selectfont\color{stewartdark}CHƯƠNG 2}\quad\textsf{\fontsize{10pt}{12pt}\selectfont\color{stewartgray}Giới hạn và Đạo hàm}}
\fancyfoot[C]{\fontsize{6pt}{7.5pt}\selectfont\color{stewartgray}\begin{tabular}{c}Copyright 2021 Cengage Learning. All Rights Reserved. May not be copied, scanned, or duplicated, in whole or in part. WCN 02-200-203\\[1pt]Editorial review has deemed that any suppressed content does not materially affect the overall learning experience. Cengage Learning reserves the right to remove additional content at any time if subsequent rights restrictions require it.\end{tabular}}
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0pt}

% Môi trường thụt lề cho các phát biểu diễn giải
\newenvironment{stewartdesc}{%
  \list{}{\leftmargin=18pt\rightmargin=0pt\topsep=3.5pt\partopsep=0pt\parsep=0pt\itemsep=0pt}%
  \item[]%
}{%
  \endlist
}
