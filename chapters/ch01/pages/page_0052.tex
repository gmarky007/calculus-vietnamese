...
\begin{minipage}[t]{0.26\textwidth}
    ...
    \vspace{1.48cm}
    \centering
    \includegraphics[width=\linewidth]{images/p0052_fig2.png}
...
\begin{minipage}[t]{0.71\textwidth}
    ...
    \vspace{0.25cm}
    \centering
    \includegraphics[width=\linewidth]{images/p0052_fig1.png}
    ...
    \vspace{0.66cm}
    \noindent
    {\color{stewartcyan}\rule{\linewidth}{1.5pt}}\\[-0.55em]
    {\color{stewartcyan}\rule{\linewidth}{0.6pt}}

    \vspace{0.2cm}
    \noindent
    {\Large\textbf{\textsf{\color{stewartcyan}1.1}}\quad {\color{stewartcyan}\rule[-2pt]{1.5pt}{14pt}}\quad \textbf{\textsf{BÀI TẬP}}}
    ...
    \begin{minipage}[t]{0.485\linewidth}
        ...
        \vspace{0.16cm}
        \centering
        \includegraphics[width=0.92\linewidth]{images/p0052_fig3.png}
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{0.485\linewidth}
        ...
        \vspace{0.16cm}
        \centering
        \includegraphics[width=0.92\linewidth]{images/p0052_fig4.png}
