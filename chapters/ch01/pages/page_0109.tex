...
\begin{minipage}[t]{0.26\textwidth}
    \vspace*{1.15cm}
    % Ghi chú bên lề 1 (dóng hàng chính xác với LỜI GIẢI)
    \noindent
    \colorbox{stewartlightblue}{%
        \parbox{\dimexpr\linewidth-2\fboxsep}{%
            \raggedright
            \colorbox{stewartpurple}{\textcolor{white}{\bfseries\sffamily\scriptsize PS}}%
            \hspace{0.2em}%
            \textsf{\footnotesize\textbf{Tương tự:} Thử bài toán tương tự, đơn giản hơn.}%
        }%
    }

    \vspace{8.2cm}
    % Ghi chú bên lề 2 (dóng hàng chính xác với bước f3)
    \noindent
    \colorbox{stewartlightblue}{%
        \parbox{\dimexpr\linewidth-2\fboxsep}{%
            \raggedright
            \colorbox{stewartpurple}{\textcolor{white}{\bfseries\sffamily\scriptsize PS}}%
            \hspace{0.2em}%
            \textsf{\footnotesize Tìm một quy luật.}%
        }%
    }
\end{minipage}%
\hfill
\begin{minipage}[t]{0.71\textwidth}
    \noindent
    \textbf{\textsf{\color{stewartcyan}VÍ DỤ 3}}\quad Nếu $f_0(x) = x/(x + 1)$ và $f_{n+1} = f_0 \circ f_n$ với $n = 0, 1, 2, \dots$, hãy tìm công thức cho $f_n(x)$.
    ...
    \makebox[\linewidth]{%
        \makebox[0pt][l]{%
            ...
            \fcolorbox{stewartred}{white}{\makebox[1.3ex]{\bfseries\sffamily\color{stewartred}\footnotesize 4}}%
        }%
        \hfill
    ...
    \medskip
    \noindent
    Biểu thức này cho thấy (4) đúng với $n = k + 1$. Do đó, theo nguyên lý quy nạp toán học, kết quả đúng với mọi số nguyên dương $n$.\hfill\textcolor{stewartcyan}{\rule{1.2ex}{1.2ex}}
\end{minipage}