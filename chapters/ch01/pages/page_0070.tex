...
\small
\noindent
đo bằng oát ($\text{W}$) và $T$ là nhiệt độ tuyệt đối đo bằng kenvin ($\text{K}$).
...
\noindent
\textbf{27.}
\begin{tabular}{@{}c@{\hspace{0.08\textwidth}}c@{}}
(a) & (b) \\
\includegraphics[width=0.42\linewidth]{images/p0070_fig1.png} &
\includegraphics[width=0.42\linewidth]{images/p0070_fig2.png}
\end{tabular}
...
\begin{tabular}{@{}c@{\hspace{0.08\textwidth}}c@{}}
(a) & (b) \\
\includegraphics[width=0.42\linewidth]{images/p0070_fig3.png} &
\includegraphics[width=0.42\linewidth]{images/p0070_fig4.png}
\end{tabular}

\vspace{0.25cm}
\noindent
{\color{stewartblue}\fbox{\textbf{\sffamily T}}}\; \textbf{29.} Bảng dưới đây cho thấy tỉ lệ mắc bệnh loét dạ dày tá tràng (tính trên 100 dân số) theo các mức thu nhập hộ gia đình khác nhau được báo cáo bởi Khảo sát Phỏng vấn Y tế Quốc gia Hoa Kỳ.
\begin{enumerate}[label=(\alph*), leftmargin=*, itemsep=2pt, topsep=2pt]
...
Thu nhập & \makecell{Tỉ lệ mắc bệnh loét\\(trên 100 người)} \\
\hline
\$4{,}000  & 14.1 \\
\$6{,}000  & 13.0 \\
\$8{,}000  & 13.4 \\
...
\small
\noindent
{\color{stewartblue}\fbox{\textbf{\sffamily T}}}\; \textbf{30.} Khi chuột bạch trong phòng thí nghiệm tiếp xúc với các sợi amiăng, một số con đã phát triển khối u ở phổi. Bảng sau liệt kê kết quả của một số thí nghiệm do các nhà khoa học khác nhau thực hiện.
\begin{enumerate}[label=(\alph*), leftmargin=*, itemsep=2pt, topsep=2pt]
...
\vspace{0.2cm}
\noindent
{\color{stewartblue}\fbox{\textbf{\sffamily T}}}\; \textbf{32.} Bảng sau cho thấy giá bán lẻ điện sinh hoạt trung bình tại Hoa Kỳ từ năm 2000 đến 2016, được tính bằng xu trên mỗi kilowatt-giờ (cents/kWh).
\begin{enumerate}[label=(\alph*), leftmargin=*, itemsep=2pt, topsep=2pt]
