...
\begin{minipage}[t]{0.26\textwidth}
    \vspace{0pt}
    \centering
    \includegraphics[width=\linewidth]{images/p0058_fig1.png}
    \vspace{-0.5em}
    \begin{flushleft}
        \textbf{\textsf{HÌNH 3}}
    \end{flushleft}
    ...
    \begin{flushright}
        ...
        {\small Biểu đồ phân tán nồng độ $\text{CO}_2$ trung bình}
    \end{flushright}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.71\textwidth}
    ...
    \vspace{0.66em}
    \noindent
    \includegraphics[width=\linewidth]{images/p0058_fig2.png}
\end{minipage}