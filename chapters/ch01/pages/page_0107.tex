...
\fancyhead[LO]{\textsf{CÁC NGUYÊN TẮC GIẢI QUYẾT VẤN ĐỀ}}
\fancyhead[RE]{\textsf{CHƯƠNG 1 \ CÁC HÀM SỐ VÀ MÔ HÌNH}}
...
\begin{minipage}[t]{0.26\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        {\color{stewartpurple}\scriptsize\textbf{\textsf{PS}}}\hspace{1.5mm}\footnotesize\textsf{Vẽ một hình vẽ.}
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[
        ...
        {\color{stewartpurple}\scriptsize\textbf{\textsf{PS}}}\hspace{1.5mm}\footnotesize\textsf{Liên hệ cái đã cho với cái chưa biết.}
    \end{tcolorbox}
    \vspace{-2mm}
    \begin{tcolorbox}[
        colback=stewartpurple!8!white,
        ...
        {\color{stewartpurple}\scriptsize\textbf{\textsf{PS}}}\hspace{1.5mm}\footnotesize\textsf{Đưa thêm yếu tố phụ.}
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[
        ...
        {\color{stewartpurple}\scriptsize\textbf{\textsf{PS}}}\hspace{1.5mm}\footnotesize\textsf{Liên hệ với điều quen thuộc.}
    \end{tcolorbox}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.71\textwidth}
    ...
    \begin{center}
        \includegraphics[width=0.7\textwidth]{images/p0107_fig1.png}
    \end{center}
    \vspace{-2mm}
    ...
    \begin{align*}
        \tikz[baseline=-0.6ex]\node[draw=stewartred,semithick,inner sep=1.5pt,rounded corners=0.5pt]{\footnotesize\textsf{\textbf{\color{stewartred}1}}}; \qquad\qquad\qquad\qquad\qquad\qquad h^2 &= a^2 + b^2 \\[1mm]
        \tikz[baseline=-0.6ex]\node[draw=stewartred,semithick,inner sep=1.5pt,rounded corners=0.5pt]{\footnotesize\textsf{\textbf{\color{stewartred}2}}}; \qquad\qquad\qquad\qquad\qquad\quad\ \, 25 &= \tfrac{1}{2}ab \\[1mm]
        \tikz[baseline=-0.6ex]\node[draw=stewartred,semithick,inner sep=1.5pt,rounded corners=0.5pt]{\footnotesize\textsf{\textbf{\color{stewartred}3}}}; \qquad\qquad\qquad\qquad\qquad\quad\ \, P &= a + b + h
    \end{align*}
