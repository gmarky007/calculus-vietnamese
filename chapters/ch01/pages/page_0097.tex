...
\begin{minipage}[t]{0.26\textwidth}
    \vspace{4.26cm}
    \noindent
    \includegraphics[height=1.1em]{images/p0097_fig3.png}\;
    {\small\color{stewartcyan}$\sin^{-1}x \neq \dfrac{1}{\sin x}$}

    \vspace{1.8cm}
    \begin{center}
        \includegraphics[width=0.98\linewidth]{images/p0097_fig4.png}\\[1mm]
        {\small\textbf{\textsf{HÌNH 19}}}
    \end{center}

    \vspace{1.48cm}
    \begin{center}
        \includegraphics[width=0.92\linewidth]{images/p0097_fig5.png}\\[1mm]
...
\begin{minipage}[t]{0.71\textwidth}
    ...
    \begin{minipage}[b]{0.61\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/p0097_fig1.png}\\[2mm]
        {\small\textbf{\textsf{HÌNH 17}}}
    \end{minipage}\hfill
    \begin{minipage}[b]{0.36\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/p0097_fig2.png}\\[2mm]
    ...
    \vspace{-0.2cm}
    \begin{center}
        \begin{tcolorbox}[colframe=stewartred, colback=white, sharp corners, boxrule=0.8pt, width=0.88\linewidth, halign=center, top=5pt, bottom=5pt]
    ...
    \vspace{-0.2cm}
    \begin{center}
        \begin{tcolorbox}[colframe=stewartred, colback=white, sharp corners, boxrule=0.8pt, width=0.88\linewidth, halign=center, top=6pt, bottom=6pt]
            \begin{align*}
