\fancyhead[L]{}
\fancyhead[R]{\small\textsf{\textbf{MỤC 1.5}\quad Hàm số ngược và Logarit}\qquad\textsf{\textbf{61}}}

\noindent
\begin{minipage}[t]{0.26\textwidth}
    \vspace{0pt}
    \includegraphics[width=\linewidth]{images/p0096_fig1.png}
    \vspace{3pt}
    \begin{flushleft}
        \textbf{\textsf{HÌNH 13}}\\[2pt]
        {\small Đồ thị của hàm số $y = \ln x$ là hình đối xứng của đồ thị hàm số $y = e^x$ qua đường thẳng $y = x$.}
    \end{flushleft}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.71\textwidth}
    ...
    \vspace{0.3em}
    \noindent Đồ thị của hàm số mũ $y = e^x$ và hàm ngược của nó, hàm logarit tự nhiên, được thể hiện trong Hình 13. Tương tự như tất cả các hàm logarit khác với cơ số lớn hơn 1, logarit tự nhiên là một hàm tăng xác định trên $(0, \infty)$ và trục $y$ là tiệm cận đứng. (Điều này có nghĩa là các giá trị của $\ln x$ trở nên âm rất lớn khi $x$ dần tiến về 0.)
...
\vspace{2pt}
\noindent
\makebox[0.26\textwidth][l]{\textbf{\textsf{HÌNH 14}}}\hfill{\color{stewartcyan}$\blacksquare$}
...
\begin{minipage}[t]{0.71\textwidth}
    ...
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{images/p0096_fig3.png}\\[3pt]
        \textbf{\textsf{HÌNH 15}}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{images/p0096_fig4.png}\\[3pt]
        \textbf{\textsf{HÌNH 16}}
    \end{minipage}
