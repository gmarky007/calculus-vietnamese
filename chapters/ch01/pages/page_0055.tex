...
\begin{minipage}[t]{0.485\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \textbf{63.} \vspace{2pt}
        \begin{center}
            \includegraphics[width=\linewidth]{images/p0055_fig1.png}
        \end{center}
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \textbf{64.} \vspace{2pt}
        \begin{center}
            \includegraphics[width=\linewidth]{images/p0055_fig2.png}
        \end{center}
    \end{minipage}
    ...
    \noindent
    \textbf{71.} Một chiếc hộp không nắp được tạo thành từ một tấm bìa các-tông hình chữ nhật có kích thước $12\text{ in.}$ nhân $20\text{ in.}$ bằng cách cắt bỏ các hình vuông bằng nhau có cạnh bằng $x$ ở mỗi góc rồi gấp các mép lên như trong hình vẽ. Hãy biểu diễn thể tích $V$ của chiếc hộp theo $x$.

    \vspace{0.33em}
    \noindent
    \begin{center}
        \includegraphics[width=0.55\linewidth]{images/p0055_fig3.png}
        \hfill
        \includegraphics[width=0.38\linewidth]{images/p0055_fig4.png}
    \end{center}
    ...
    \vspace{0.25em}
    \begin{center}
        \includegraphics[width=0.38\linewidth]{images/p0055_fig5.png}
    \end{center}
