\thispagestyle{fancy}
\fancyhf{}
\fancyhead[LE,LO]{\small\textbf{\textsf{60}}\quad\textbf{\textsf{CHƯƠNG 1}}\quad\textsf{Hàm số và Mô hình}}
\fancyhead[RE,RO]{}
...
\begin{align*}
\ln \frac{x^2\sqrt{x^2 + 2}}{3x + 1} &= \ln x^2 + \ln\sqrt{x^2 + 2} - \ln(3x + 1)\\[3pt]
...
\begin{align*}
\ln a + \tfrac{1}{2}\ln b &= \ln a + \ln b^{1/2}\\[3pt]
&= \ln a + \ln\sqrt{b}\\[3pt]
...
\vspace{0.25cm}
\begin{tcolorbox}[colback=white, colframe=stewartred, arc=1.5mm, boxrule=0.8pt, left=10pt, right=10pt, top=7pt, bottom=7pt]
\noindent{\setlength{\fboxrule}{0.8pt}\fboxsep=2pt\color{stewartred}\fbox{\rule[-1pt]{0pt}{9pt}\textbf{\textsf{11}}}}\;\textbf{\textsf{\color{stewartred}Công thức đổi cơ số}}\quad Với mọi số dương $b$ ($b \ne 1$), ta có
\[
