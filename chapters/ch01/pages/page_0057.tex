...
\begin{tikzpicture}[>=stealth, font=\sffamily]
    % Các khối
    \node[draw=cyan!70!black, fill=cyan!15, rounded corners=1pt, minimum width=2.4cm, minimum height=1.1cm, align=center] (n1) at (0,0) {Vấn đề\\thực tế};
    \node[draw=magenta!60!black, fill=magenta!15, rounded corners=1pt, minimum width=2.4cm, minimum height=1.1cm, align=center] (n2) at (4.5,0) {Mô hình\\toán học};
    \node[draw=green!60!black, fill=green!15, rounded corners=1pt, minimum width=2.4cm, minimum height=1.1cm, align=center] (n3) at (9.0,0) {Kết luận\\toán học};
    \node[draw=orange!70!black, fill=orange!20, rounded corners=1pt, minimum width=2.4cm, minimum height=1.1cm, align=center] (n4) at (13.5,0) {Dự đoán\\thực tế};

    % Mũi tên tiến
    \draw[->, thick] (n1) -- node[above, font=\small] {Thiết lập} (n2);
    \draw[->, thick] (n2) -- node[above, font=\small] {Giải} (n3);
    \draw[->, thick] (n3) -- node[above, font=\small] {Diễn giải} (n4);

    % Vòng phản hồi
    \draw[->, thick] (n4.south) -- ++(0,-0.85) -- node[above, font=\small] {Kiểm tra} ++(-13.5,0) -- (n1.south);
\end{tikzpicture}
}
...
\begin{minipage}[t]{0.26\textwidth}
    \vspace{0pt}
    \noindent
    \textbf{\textsf{HÌNH 1}}\\\textsf{\small Quá trình mô hình hóa}
...
\begin{minipage}[t]{0.71\textwidth}
    ...
    \begin{minipage}[c]{0.48\linewidth}
        ...
        \begin{tikzpicture}[scale=0.95, >=stealth]
            \draw[->] (-0.8,0) -- (2.3,0) node[below] {\small $x$};
            \draw[->] (0,-2.6) -- (0,2.4) node[left] {\small $y$};
            \node[below left] at (0,0) {\small $0$};
            
            \draw[dashed, gray!80] (1,0) -- (1,1) -- (0,1);
            ...
            \draw[thick, stewartblue, domain=-0.15:1.4] plot (\x, {3*\x - 2});
            \node[right, font=\small] at (0.4,1.7) {$y = 3x - 2$};
        \end{tikzpicture}
    \end{minipage}%
    \hfill
    \begin{minipage}[c]{0.48\linewidth}
        ...
        \begin{tabular}{|>{\centering\arraybackslash}p{1.3cm}|>{\centering\arraybackslash}p{2.3cm}|}
            \hline
