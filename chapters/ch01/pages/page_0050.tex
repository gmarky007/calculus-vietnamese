...
\begin{minipage}[t]{0.26\textwidth}
    ...
    \vspace{1.5mm}
    \noindent\footnotesize Dạng phương trình đường thẳng qua một điểm với hệ số góc là $y - y_1 = m(x - x_1)$. Xem Phụ lục B.

    \vspace{2.0cm}
    \begin{center}
        \includegraphics[width=0.95\linewidth]{images/p0050_fig4.png}
        \vspace{1mm}
