...
\begin{minipage}[t]{0.26\textwidth}
    ...
    \noindent
    \centering
    \includegraphics[width=0.95\linewidth]{images/p0086_fig2.png}\par\vspace{2pt}
    {\footnotesize (a) $y = e^x$}\par\vspace{6pt}
    \raggedright
    \textbf{\textsf{HÌNH 16}}
    ...
    \noindent
    \centering
    \includegraphics[width=\linewidth]{images/p0086_fig6.png}\par\vspace{6pt}
    \raggedright
    \textbf{\textsf{HÌNH 17}}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.71\textwidth}
    ...
    \vspace{0.16cm}
    \begin{center}
        \includegraphics[width=0.55\linewidth]{images/p0086_fig1.png}
    \end{center}
    ...
    \vspace{0.16cm}
    \noindent
    \textbf{\textsf{\color{stewartcyan}LỜI GIẢI}}\hspace{0.8em}Ta bắt đầu với đồ thị của hàm số $y = e^x$ từ Hình 14 và 16(a), rồi lấy đối xứng qua trục $y$ để thu được đồ thị của $y = e^{-x}$ trong Hình 16(b). (Lưu ý rằng tiếp tuyến của đồ thị tại giao điểm với trục $y$ có hệ số góc bằng $-1$.) Sau đó, ta co đồ thị theo phương thẳng đứng với hệ số 2 để nhận được đồ thị của $y = \frac{1}{2}e^{-x}$ trong Hình 16(c). Cuối cùng, ta tịnh tiến đồ thị xuống dưới một đơn vị để thu được đồ thị mong muốn trong Hình 16(d). Tập xác định là $\mathbb{R}$ và tập giá trị là $(-1, \infty)$.

    \vspace{0.33cm}
    \noindent
    \begin{minipage}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/p0086_fig3.png}\par\vspace{2pt}
        {\footnotesize (b) $y = e^{-x}$}
    \end{minipage}\hfill
    \begin{minipage}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/p0086_fig4.png}\par\vspace{2pt}
        {\footnotesize (c) $y = \frac{1}{2}e^{-x}$}
    \end{minipage}\hfill
    \begin{minipage}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/p0086_fig5.png}\par\vspace{2pt}
        {\footnotesize (d) $y = \frac{1}{2}e^{-x} - 1$}
    \end{minipage}\hfill
    \smash{\raisebox{2pt}{\color{stewartcyan}$\blacksquare$}}
    ...
    \vspace{0.25cm}
    \noindent
    \textbf{\textsf{\color{stewartcyan}VÍ DỤ 6}}\hspace{0.8em}Sử dụng máy tính cầm tay có chức năng vẽ đồ thị hoặc máy vi tính để tìm các giá trị của $x$ sao cho $e^x > 1\,000\,000$.
