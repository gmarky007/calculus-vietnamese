...
\begin{minipage}[t]{0.26\textwidth}
    ...
    \begin{tcolorbox}[colback=stewartpurplebg, colframe=stewartpurplebg, arc=1mm, boxrule=0pt, left=2.5mm, right=2.5mm, top=2.5mm, bottom=2.5mm]
        \colorbox{stewartpurpletext}{\textcolor{white}{\sffamily\bfseries\scriptsize PS}}\; {\footnotesize Khi thiết lập các hàm số ứng dụng như trong Ví dụ 5, việc xem lại các nguyên tắc giải quyết vấn đề ở cuối chương này là rất hữu ích, đặc biệt là \textit{Bước 1: Hiểu bài toán}.}
    \end{tcolorbox}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.71\textwidth}
    ...
    \]
    Để biểu diễn chi phí $C$ chỉ theo một biến duy nhất là $w$, ta cần khử biến $h$. Ta thực hiện điều này bằng cách sử dụng giả thiết thể tích của khối hộp là $10\text{ m}^3$. Do đó
    \[
    w(2w)h = 10
    \]
    cho ta
    ...
    \]
    biểu diễn chi phí $C$ dưới dạng một hàm số của chiều rộng $w$. \hfill {\color{stewartcyan}$\blacksquare$}
