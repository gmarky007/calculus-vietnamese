...
\definecolor{stewartgreen}{RGB}{0, 138, 63}
\definecolor{stewartred}{RGB}{205, 35, 35}

\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\fancyhead[R]{\fontsize{9pt}{11pt}\selectfont\textbf{\textsf{MỤC 4.4}}\hspace{1.5em}\textsf{Dạng vô định và quy tắc l’Hospital}\hspace{3em}\textbf{\textsf{311}}}

\newcommand{\prohibitionicon}{%
  \begin{tikzpicture}[baseline=-2pt, scale=0.7]
    \draw[stewartred, line width=1.1pt] (0,0) circle (5pt);
    \draw[stewartred, line width=1.1pt] (-3.5pt,-3.5pt) -- (3.5pt,3.5pt);
  \end{tikzpicture}%
}
