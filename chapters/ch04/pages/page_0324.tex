...
\usepackage[letterpaper, top=1.4cm, bottom=1.4cm, left=1.3cm, right=1.3cm]{geometry}
\usepackage{fontspec}
...
\definecolor{projectgreen}{RGB}{0, 133, 117}

\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\rhead{\small\textsf{\textbf{\color{projectgreen}DỰ ÁN ỨNG DỤNG}}\quad\textsf{Giải tích về cầu vồng}\qquad\textbf{\textsf{289}}}
