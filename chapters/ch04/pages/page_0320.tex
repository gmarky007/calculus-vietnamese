...
\usepackage[letterpaper, top=1.8cm, bottom=2.0cm, left=1.5cm, right=1.5cm, headheight=14pt]{geometry}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\small\textsf{\textbf{MỤC 4.1}}\quad\textsf{Giá trị lớn nhất và giá trị nhỏ nhất}\qquad\textsf{\textbf{285}}}
\fancyfoot[C]{\fontsize{6.5}{8}\selectfont\color{gray!80!black}%
...
\begin{minipage}[t]{0.25\textwidth}
    ...
    \vspace{38pt}
    \noindent\includegraphics[width=\linewidth]{images/p0320_fig3.png}
\end{minipage}%
\hfill
