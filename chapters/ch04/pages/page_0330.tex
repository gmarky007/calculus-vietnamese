...
\usepackage[paperwidth=8.5in, paperheight=11in, top=0.45in, bottom=0.45in, left=0.65in, right=0.65in]{geometry}
...
% Định nghĩa màu chuẩn giáo trình James Stewart Calculus
...
\fancyhead[R]{{\sffamily\bfseries\footnotesize MỤC 4.2}\hspace{1.2em}{\sffamily\footnotesize Định lý Giá trị Trung bình}\hspace{2.2em}{\sffamily\bfseries\normalsize 295}}
\fancyfoot[C]{\fontsize{6.5pt}{7.5pt}\selectfont\color{black!60}Bản dịch tiếng Việt dùng cho mục đích học tập và nghiên cứu. Nguyên tác: \textit{Calculus: Early Transcendentals (9th Edition)} -- James Stewart.}
