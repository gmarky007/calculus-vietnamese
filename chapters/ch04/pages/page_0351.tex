...
\usepackage[paperwidth=8.5in, paperheight=11in, top=0.5in, bottom=0.5in, left=0.65in, right=0.65in]{geometry}
...
\definecolor{stewartcyan}{RGB}{0, 136, 168}

\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\fancyhead[L]{\textsf{\textbf{316}}\qquad \textsf{\textbf{\color{stewartcyan}CHƯƠNG 4}}\quad \textsf{\textbf{Ứng dụng của đạo hàm}}}
\fancyhead[R]{}
