...
\usepackage[letterpaper, top=1.4cm, bottom=1.2cm, left=1.8cm, right=1.8cm]{geometry}
...
% Màu nhận diện đặc trưng của giáo trình Stewart Calculus
\definecolor{stewartblue}{RGB}{0, 130, 185}

\setlength{\parindent}{1.2em}
\setlength{\parskip}{0pt}

% Giảm khoảng cách công thức toán hiển thị để trang vừa vặn, chuẩn xác
