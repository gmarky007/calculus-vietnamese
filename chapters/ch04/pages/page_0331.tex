...
\definecolor{stewartrule}{RGB}{175, 210, 230}
\definecolor{stewartgray}{RGB}{100, 100, 100}

\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt}
\fancyhead[L]{\textbf{\textsf{296}}\qquad\textbf{\textsf{\color{stewartgray}CHƯƠNG 4}}\quad\textsf{Các ứng dụng của đạo hàm}}
\fancyfoot[C]{\fontsize{7pt}{8pt}\selectfont\color{stewartgray}Copyright 2021 Cengage Learning. Mọi quyền được bảo lưu. Bản dịch tiếng Việt phục vụ mục đích học tập.}

\newcommand{\graphingicon}{%
  \begin{tikzpicture}[baseline=-0.6ex, scale=0.75]
    \draw[color=stewartcyan, line width=0.8pt, rounded corners=1.2pt] (0,0) rectangle (1.1, 0.85);
    \draw[color=stewartcyan, line width=0.5pt] (0.15, 0.425) -- (0.95, 0.425);
    \draw[color=stewartcyan, line width=0.5pt] (0.55, 0.12) -- (0.55, 0.73);
    \draw[color=stewartcyan, line width=0.7pt, smooth, domain=0.2:0.9, samples=20] 
      plot (\x, {0.425 + 0.22*sin((\x-0.55)*400)});
  \end{tikzpicture}%
}

\newcommand{\exerciseline}{\vspace{4pt}{\color{stewartrule}\hrule height 0.5pt}\vspace{4pt}}
