...
\usepackage[paperwidth=215.9mm, paperheight=279.4mm, left=16mm, right=16mm, top=20mm, bottom=18mm]{geometry}
...
\definecolor{stewartgreen}{RGB}{0, 136, 86}
\definecolor{stewartgray}{RGB}{110, 110, 110}

% Ký hiệu cảnh báo chuẩn Stewart (biển cấm hình tròn gạch chéo)
\newcommand{\warningsign}{%
  \begin{tikzpicture}[baseline=-0.6ex, scale=0.82]
    \draw[stewartred, line width=1.5pt] (0,0) circle (7pt);
    \draw[stewartred, line width=1.5pt] (-4.95pt, 4.95pt) -- (4.95pt, -4.95pt);
  \end{tikzpicture}%
}
...
\fancyhead[R]{\footnotesize\textsf{\textbf{MỤC 4.1}\quad Giá trị lớn nhất và nhỏ nhất\qquad\textbf{283}}}
\fancyhead[L]{}
