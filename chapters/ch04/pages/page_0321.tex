...
\usepackage{geometry}
\geometry{left=1.8cm, right=1.8cm, top=2.2cm, bottom=2.0cm}
\usepackage{xcolor}
\usepackage{tikz}
...
% Định nghĩa bảng màu chuẩn giáo trình Stewart Calculus
\definecolor{stewartcyan}{RGB}{0, 140, 200}
\definecolor{stewartblue}{RGB}{0, 102, 170}
\definecolor{stewartgray}{RGB}{100, 100, 100}
\definecolor{gridgray}{RGB}{215, 215, 215}
\definecolor{graphred}{RGB}{215, 40, 40}

% Cấu hình header & footer
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{ontsize{9pt}{11pt}\selectfont\textbf{286}\qquad\textbf{\textsf{CHƯƠNG 4}}\quad\textsf{Các ứng dụng của đạo hàm}}
\fancyhead[R]{}
