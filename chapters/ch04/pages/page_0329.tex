...
\usepackage[paperwidth=8.5in, paperheight=11in, top=1in, bottom=1in, left=0.75in, right=0.75in]{geometry}
...
% Định nghĩa hệ màu đặc trưng của sách Stewart Calculus
\definecolor{stewartcyan}{RGB}{0, 130, 195}
\definecolor{stewartred}{RGB}{208, 40, 35}
\definecolor{stewartgreen}{RGB}{0, 135, 60}
...
\fancyhead[L]{%
  ...
  \textbf{294}\qquad%
  \textsf{\textbf{CHƯƠNG 4}}\quad%
  \textsf{Các ứng dụng của đạo hàm}%
}

% Hộp số định lý và phương trình
\newcommand{\stewartboxnum}[1]{%
  \tcbox[on line, colback=white, colframe=stewartred, arc=0mm, boxrule=0.8pt,
         left=3pt, right=3pt, top=1.5pt, bottom=1.5pt]{%
    \fontsize{9.5}{11}\selectfont\sffamily\bfseries\color{stewartred}#1%
  }%
}

% Khung định lý / hệ quả viền đỏ
\newtcolorbox{stewarttheorembox}{
  enhanced,
  colback=white,
  colframe=stewartred,
  arc=0mm,
