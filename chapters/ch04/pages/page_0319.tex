...
\definecolor{stewartred}{RGB}{205, 35, 30}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textbf{\textsf{284}}\qquad\textbf{\textsf{CHƯƠNG 4}}\quad\textsf{Các ứng dụng của đạo hàm}}
\fancyhead[R]{}
...
\newcommand{\stewartboxnum}[1]{%
    ...
    \textcolor{stewartred}{\fbox{\bfseries\strut\fontsize{8.5pt}{10pt}\selectfont\makebox[0.7em]{\color{stewartred}#1}}}%
    \endgroup
}
